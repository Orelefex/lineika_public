// ===== js/modules/weather-processor.js =====
// Модуль для обработки погодных данных и выделения опасных явлений

// Список опасных метеоявлений для автоматического выделения
export const DANGEROUS_WEATHER_PATTERNS = [
 ...
 * @returns {Object|null} - результат разбора или null
 */
 ...
 * @param {string} text - исходный текст
 * @returns {Object} - объект с разделенным текстом
 */
export function processWeatherText(text) {
 ...
 * @param {string} text - исходный текст
 * @returns {Object} - структура для метода parseCondition
 */
export function processConditionText(text) {
